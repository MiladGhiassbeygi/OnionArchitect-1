...
namespace Infra.Authentication.Jwt.Services
{
    public class TokenService:ITokenService
    {
        ...
        public async Task<UserToken> FindRefreshToken(int userId,string refreshToken,CancellationToken cancellationToken=default(CancellationToken))
        {
        ...
        public async Task DeleteRefreshTokenAsync(long id, CancellationToken cancellationToken=default(CancellationToken))
        {
        ...
        public async Task DeleteExpiredRefreshTokensAsync(CancellationToken cancellationToken=default(CancellationToken))
        {
